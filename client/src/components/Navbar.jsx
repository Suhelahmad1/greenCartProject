...
const Navbar = () => {
  ...
  const logout = async () => {
    try {
      const { data } = await axios.get("/api/user/logout", {
        withCredentials: true, // must for cross-origin cookies
      });
  ...
  return (
    <nav className="flex items-center justify-between px-4 md:px-14 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
