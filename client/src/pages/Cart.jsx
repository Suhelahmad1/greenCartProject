  ...
  const placeOrder = async () => {
    try {
      ...
      if (paymentOption === "COD") {
        ({ data } = await axios.post("/api/order/cod", orderPayload, {
        ...
        // Stripe payment
        ({ data } = await axios.post("/api/order/stripe", orderPayload, {
      ...
      <div className="flex-1 max-w-4xl">
        ...
        {cartArray.map((product, index) => (
          ...
          >
            ...
            <button className="cursor-pointer mx-auto" aria-label="Remove item">
              <img
            ...
            {showAddress && (
              <div className="absolute top-12 py-1 bg-white border border-gray-300 text-sm w-full z-10">
                {addresses.map((address, index) => (
                  <p
                    key={index} // ✅ Added key here to prevent React warning
                    onClick={() => {
